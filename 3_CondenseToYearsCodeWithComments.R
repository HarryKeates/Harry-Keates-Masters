...
original_data <- read.csv("C:/Users/harry/Documents/MastersDataAnalysis/Current/OutputDuplicatesRemoved.csv")
...
write.csv(condensed_data, "OutputCondensedMean.csv", row.names = FALSE)
...
write.csv(condensed_data, "OutputCondensedSum.csv", row.names = FALSE)
